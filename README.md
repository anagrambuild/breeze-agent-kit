...
- `apps/examples/agent-using-x402-payment-api`: Claude tool-calling agent that interacts with Breeze over the x402 API and signs/sends returned transactions
