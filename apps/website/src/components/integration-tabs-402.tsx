		...
		<div>
			...
			<div className="text-sm mb-6 space-y-2">
				...
				<div className="flex gap-3">
					...
					<span>Agent pays ~$0.001 USDC on-chain to the specified address</span>
				</div>
				<div className="flex gap-3">
			...
			<p className="text-xs text-dim mb-4">
				The payment is ~$0.001 USDC per request. Use <code>@faremeter/fetch</code> to handle the 402
				flow automatically:
			</p>
